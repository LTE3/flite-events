...
export function Footer() {
  return (
    <footer className="bg-bg-card border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        {/* Top: brand + socials */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
          <div>
            <Link href="/" className="inline-block">
              <span className="font-[family-name:var(--font-display)] text-lg font-extrabold tracking-[-0.02em]">
                <span className="text-white">PULSE</span>
                <span className="text-accent">TIX</span>
              </span>
            </Link>
            <p className="text-sm text-text-dim mt-2">NYC nightlife, one tap.</p>
          </div>
